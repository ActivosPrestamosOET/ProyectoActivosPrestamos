...
-- --------------------------------------------------
-- Date Created: 7/6/2016 9:58:55 a. m.
...
CREATE TABLE "ACTIVOS"."V_EMPLEADOS" (
   ...
   "ESTADOCIVIL" NUMBER(8,2) ,
   "IDEMPLEADO" VARCHAR2(30 CHAR) NOT NULL,
   "IDENTIFICACION" VARCHAR2(50 CHAR) NOT NULL,
   "IDNACIONALIDAD" VARCHAR2(26 CHAR) NOT NULL,
   "IDTIPO" NUMBER(8,2) NOT NULL,
   "NOMBRE" VARCHAR2(50 CHAR) NOT NULL,
   "NUMASEGURADO" VARCHAR2(50 CHAR) ,
   "NUMEMPLEADO" NUMBER(8,2) NOT NULL,
   "SEXO" CHAR(1 CHAR) NOT NULL,
   "ASOET" NUMBER(1) ,
   "CREA" VARCHAR2(30 CHAR) ,
   "MODIFICA" VARCHAR2(30 CHAR) ,
   "CREADO" DATE ,
   "MODIFICADO" DATE ,
   "FECHA_NACIMIENTO" DATE ,
   "NUM_ASOET" VARCHAR2(50 CHAR) ,
   "PENSIONADO" NUMBER(3) 
);
