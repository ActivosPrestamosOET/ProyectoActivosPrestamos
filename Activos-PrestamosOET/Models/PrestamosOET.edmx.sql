...
-- --------------------------------------------------
-- Date Created: 4/24/2016 11:22:02 AM
...
CREATE TABLE "ACTIVOS"."ACTIVOS" (
   ...
   "V_PROVEEDOR_IDPROVEEDOR" VARCHAR2(50 CHAR) NOT NULL,
   "V_PROVEEDOR_FECHAINGRESO" DATE NOT NULL,
   "V_PROVEEDOR_NOMBRE" VARCHAR2(50 CHAR) NOT NULL,
   "V_PROVEEDOR_ESTADO" NUMBER(1) NOT NULL,
   "V_PROVEEDOR_CEDULA" VARCHAR2(50 CHAR) NOT NULL,
   "V_PROVEEDOR_LOCACION" NUMBER(1) NOT NULL,
   "V_PROVEEDOR_CREADO" DATE NOT NULL,
   "V_PROVEEDOR_CREADOR" VARCHAR2(50 CHAR) NOT NULL,
   "V_PROVEEDOR_MODIFICADO" DATE NOT NULL,
   "V_PROVEEDOR_MODIFICADOR" VARCHAR2(50 CHAR) NOT NULL,
   "V_ANFITRIONA_ID" VARCHAR2(2 CHAR) NOT NULL,
   "V_ANFITRIONA_NOMBRE" VARCHAR2(100 CHAR) NOT NULL,
   "V_ANFITRIONA_SIGLAS" VARCHAR2(20 CHAR) NOT NULL,
   "V_ANFITRIONA_MONEDA" VARCHAR2(26 CHAR) NOT NULL,
   "V_ANFITRIONA_TIPOCAMBIO" VARCHAR2(10 CHAR) NOT NULL,
   "V_ANFITRIONA_TIPOUSUARIO" NUMBER(38) NOT NULL,
   "V_ANFITRIONA_TIPOCAMBIO_CONTA" VARCHAR2(10 CHAR) NOT NULL,
   "V_ANFITRIONA_MONEDA_CONTA" VARCHAR2(26 CHAR) NOT NULL,
   "V_ESTACION_ID" VARCHAR2(26 CHAR) NOT NULL,
   "V_ESTACION_NOMBRE" VARCHAR2(100 CHAR) NOT NULL
);
...
CREATE TABLE "ACTIVOS"."V_ANFITRIONA" (
   ...
   "V_MONEDA_ID" VARCHAR2(26 CHAR) NOT NULL
);
...
-- Creating foreign key on "V_MONEDA_ID" in table 'V_ANFITRIONA'
ALTER TABLE "ACTIVOS"."V_ANFITRIONA"
ADD CONSTRAINT "FK_V_MONEDAV_ANFITRIONA"
   FOREIGN KEY ("V_MONEDA_ID")
   REFERENCES "ACTIVOS"."V_MONEDA"
       ("ID")
   ENABLE
   VALIDATE;

-- Creating index for FOREIGN KEY 'FK_V_MONEDAV_ANFITRIONA'
CREATE INDEX "IX_FK_V_MONEDAV_ANFITRIONA"
ON "ACTIVOS"."V_ANFITRIONA"
   ("V_MONEDA_ID");

-- Creating foreign key on "V_PROVEEDOR_IDPROVEEDOR", "V_PROVEEDOR_FECHAINGRESO", "V_PROVEEDOR_NOMBRE", "V_PROVEEDOR_ESTADO", "V_PROVEEDOR_CEDULA", "V_PROVEEDOR_LOCACION", "V_PROVEEDOR_CREADO", "V_PROVEEDOR_CREADOR", "V_PROVEEDOR_MODIFICADO", "V_PROVEEDOR_MODIFICADOR" in table 'ACTIVOS'
ALTER TABLE "ACTIVOS"."ACTIVOS"
ADD CONSTRAINT "FK_V_PROVEEDORACTIVO"
   FOREIGN KEY ("V_PROVEEDOR_IDPROVEEDOR", "V_PROVEEDOR_FECHAINGRESO", "V_PROVEEDOR_NOMBRE", "V_PROVEEDOR_ESTADO", "V_PROVEEDOR_CEDULA", "V_PROVEEDOR_LOCACION", "V_PROVEEDOR_CREADO", "V_PROVEEDOR_CREADOR", "V_PROVEEDOR_MODIFICADO", "V_PROVEEDOR_MODIFICADOR")
   REFERENCES "ACTIVOS"."V_PROVEEDOR"
       ("IDPROVEEDOR", "FECHAINGRESO", "NOMBRE", "ESTADO", "CEDULA", "LOCACION", "CREADO", "CREADOR", "MODIFICADO", "MODIFICADOR")
   ENABLE
   VALIDATE;
...
ON "ACTIVOS"."ACTIVOS"
   ("V_PROVEEDOR_IDPROVEEDOR", "V_PROVEEDOR_FECHAINGRESO", "V_PROVEEDOR_NOMBRE", "V_PROVEEDOR_ESTADO", "V_PROVEEDOR_CEDULA", "V_PROVEEDOR_LOCACION", "V_PROVEEDOR_CREADO", "V_PROVEEDOR_CREADOR", "V_PROVEEDOR_MODIFICADO", "V_PROVEEDOR_MODIFICADOR");

-- Creating foreign key on "V_ANFITRIONA_ID", "V_ANFITRIONA_NOMBRE", "V_ANFITRIONA_SIGLAS", "V_ANFITRIONA_MONEDA", "V_ANFITRIONA_TIPOCAMBIO", "V_ANFITRIONA_TIPOUSUARIO", "V_ANFITRIONA_TIPOCAMBIO_CONTA", "V_ANFITRIONA_MONEDA_CONTA" in table 'ACTIVOS'
ALTER TABLE "ACTIVOS"."ACTIVOS"
ADD CONSTRAINT "FK_ACTIVOV_ANFITRIONA"
   FOREIGN KEY ("V_ANFITRIONA_ID", "V_ANFITRIONA_NOMBRE", "V_ANFITRIONA_SIGLAS", "V_ANFITRIONA_MONEDA", "V_ANFITRIONA_TIPOCAMBIO", "V_ANFITRIONA_TIPOUSUARIO", "V_ANFITRIONA_TIPOCAMBIO_CONTA", "V_ANFITRIONA_MONEDA_CONTA")
   REFERENCES "ACTIVOS"."V_ANFITRIONA"
       ("ID", "NOMBRE", "SIGLAS", "MONEDA", "TIPOCAMBIO", "TIPOUSUARIO", "TIPOCAMBIO_CONTA", "MONEDA_CONTA")
   ENABLE
   VALIDATE;

-- Creating index for FOREIGN KEY 'FK_ACTIVOV_ANFITRIONA'
CREATE INDEX "IX_FK_ACTIVOV_ANFITRIONA"
ON "ACTIVOS"."ACTIVOS"
   ("V_ANFITRIONA_ID", "V_ANFITRIONA_NOMBRE", "V_ANFITRIONA_SIGLAS", "V_ANFITRIONA_MONEDA", "V_ANFITRIONA_TIPOCAMBIO", "V_ANFITRIONA_TIPOUSUARIO", "V_ANFITRIONA_TIPOCAMBIO_CONTA", "V_ANFITRIONA_MONEDA_CONTA");

-- Creating foreign key on "V_ESTACION_ID", "V_ESTACION_NOMBRE" in table 'ACTIVOS'
ALTER TABLE "ACTIVOS"."ACTIVOS"
ADD CONSTRAINT "FK_V_ESTACIONACTIVO"
   FOREIGN KEY ("V_ESTACION_ID", "V_ESTACION_NOMBRE")
...
ON "ACTIVOS"."ACTIVOS"
   ("V_ESTACION_ID", "V_ESTACION_NOMBRE");
